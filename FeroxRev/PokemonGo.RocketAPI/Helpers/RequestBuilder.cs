...
using Cv3PKM.RocketAPI.Enums;
using Cv3PKM.Protos.Networking.Envelopes;
...
namespace Cv3PKM.RocketAPI.Helpers
{
    public class RequestBuilder
    {
        ...
        {
            var sig = new Cv3PKM.Protos.Networking.Signature();
            sig.TimestampSinceStart = (ulong)_internalWatch.ElapsedMilliseconds;
            sig.Timestamp = (ulong)DateTime.UtcNow.ToUnixTime();
            sig.SensorInfo = new Cv3PKM.Protos.Networking.Signature.Types.SensorInfo()
            {
            ...
            sig.DeviceInfo = new Cv3PKM.Protos.Networking.Signature.Types.DeviceInfo()
            {
            ...
            sig.LocationFix.Add(new Cv3PKM.Protos.Networking.Signature.Types.LocationFix()
            {
                Provider = "network",
        ...
        public RequestEnvelope GetInitialRequestEnvelope(params Request[] customRequests)
        {
            var e = new RequestEnvelope
            {
                ...
                Longitude = _longitude, //8
                Altitude = _altitude, //9
                AuthInfo = new Cv3PKM.Protos.Networking.Envelopes.RequestEnvelope.Types.AuthInfo
                {
                    Provider = _authType == AuthType.Google ? "google" : "ptc",
                    Token = new Cv3PKM.Protos.Networking.Envelopes.RequestEnvelope.Types.AuthInfo.Types.JWT
                    {
                        Contents = _authToken,
                        Unknown2 = 14
                    }
