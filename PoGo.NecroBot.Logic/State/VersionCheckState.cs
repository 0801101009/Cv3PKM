...
namespace Cv3PKM.Bot.Logic.State
{
    public class VersionCheckState : IState
    {
        public const string VersionUri =
            "https://rawgit.com/NoxxDev/Cv3PKM/master/Cv3PKM.Bot.Logic/Properties/AssemblyInfo.cs";

        public const string LatestReleaseApi =
            "https://api.github.com/repos/NoxxDev/Cv3PKM/releases/latest";

        private const string LatestRelease =
            "https://github.com/NoxxDev/Cv3PKM/releases";
        ...
        public async Task<IState> Execute(ISession session, CancellationToken cancellationToken)
        {
            ...
            var remoteReleaseUrl =
                $"https://github.com/NoxxDev/Cv3PKM/releases/download/v{RemoteVersion}/";
